...
#Methods of Api Returns
  def matchVillage
    @village = Village.where("name LIKE '%" + params[:name].to_s  + "%'",)
      respond_to do |format|
  ...
  private
    ...
    def village_params
      params.require(:village).permit(:name, :info_text, :latitude, :longitude, :photo1, :photo2, :photo3, :photo4, :phone_municipality, :phone_info_tourism)
    end
end
